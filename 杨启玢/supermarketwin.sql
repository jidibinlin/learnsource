...
alter table Product add type char(20) ; 

create table Director(
    proNum char(20) not null,
    constraint DirecFkey foreign key(proNum) references Product(proNum),
    emNum char(11) not null,
    constraint DirecFkey1 foreign key(emNum) references Employee(emNum),
	constraint Direcpkey primary key(proNum,emNum)
);

insert into Director (proNum,emNum)
values('P2','A02'),
('P3','A02'),
('P5','A03');
